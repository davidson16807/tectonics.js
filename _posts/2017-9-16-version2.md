...
![](images/version2/version1_crust_age.png){:width=100%}

Ho boy. This wasn't what I expected.

Take these results and compare them with Earth. 

![](images/version2/earth_crust_age.jpg){:width=100%}
...
Version 2.0 was so much a change that I even debated creating a new website for it, but version 2.0 is so much better than the original that I don't want to leave any uncertainty among the users: 
...
![](images/version2/pitch_drop.gif)
...
![](images/version2/vector_field_example.jpg)
...
![](images/version2/subductability_smoothed_gradient.png)
...
![](images/version2/version2_crust_age.png){:width=100%}
