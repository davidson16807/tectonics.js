...
So which design suits our needs? Does the landscape grow or shrink, like with chunks in Minecraft? In that case, AoS is clearly the best option. 

![](images/version2/minecraft_chunks.png){:height="256px"}

But what if the landscape is static? What if you work on GIS software, and the quantities you track all come from many data sources that each work with different resolutions? 

![](images/version2/GIS_layers.jpg){:width="256px"}
...
Tectonics.js uses this equation to approximate the 2d motion of the mantle. It starts off with crust age (older crust is blue):
