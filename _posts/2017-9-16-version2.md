...
<p>`rho {((delv)/(delt)) + (v*nabla)v} = -nabla p -rho nabla phi + eta nabla^2 v + (eta + eta') nabla(nabla*v)`</p>
...
![](images/version2/detaching.png){:height="256px" width="256px"}
...
![](images/version2/rifting.png){:height="256px" width="256px"}
