...
// "xtop" is the distance along the ray from surface to the the top of the atmosphere.
...
vec3 get_rgb_intensity_of_light_rays_through_atmosphere(
    ...
    float view_x_R; // distance along the view ray from closest approach to world
    float view_x_top; // distance along the view ray from world to top of atmosphere
 ...
 view_x_R = view_x_exit_world - view_x_z;
 view_x_top = view_x_exit_atmo - view_x_exit_world;
    view_sigma0 =
         approx_sigma0( view_x_top, view_x_R, view_z2, world_radius, atmosphere_scale_height);
   ...
   light_z2, light_x_z,
        ...
        view_sigma =
            approx_sigma( view_x -view_x_ref, view_x_top, view_x_R, view_sigma0, view_z2, world_radius, atmosphere_scale_height)-
            approx_sigma( view_x_start -view_x_ref, view_x_top, view_x_R, view_sigma0, view_z2, world_radius, atmosphere_scale_height);
        light_sigma0 =
