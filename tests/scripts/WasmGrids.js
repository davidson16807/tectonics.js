...
Cpp().then(function(x) {
	...
	test_grid_values(tetrahedron, cpp.vec3s_to_lists, [
		{ attribute: 'vertex_positions',    value: {"x":[0,1,0,0],
												    "y":[0,0,1,0],
	                                                "z":[0,0,0,1]} },
		// { attribute: 'vertex_normals',      value: [[]] },
		{ attribute: 'face_endpoint_a',     value: {"x":[0,0,0,1],
												    "y":[0,0,0,0],
	                                                "z":[0,0,0,0]} },
		{ attribute: 'face_endpoint_b',     value: {"x":[1,1,0,0],
												    "y":[0,0,1,1],
	                                                "z":[0,0,0,0]} },
		{ attribute: 'face_endpoint_c',     value: {"x":[0,0,0,0],
												    "y":[1,0,0,0],
	                                                "z":[0,1,1,1]} },
		// { attribute: 'face_midpoints',      value: [[]] },
		// { attribute: 'face_normals',        value: [[]] },
		{ attribute: 'edge_endpoint_a',     value: {"x":[0,0,0,1,1,0],
												    "y":[0,0,0,0,0,1],
	                                                "z":[0,0,0,0,0,0]} },
		{ attribute: 'edge_endpoint_b',     value: {"x":[1,0,0,0,0,0],
												    "y":[0,1,0,1,0,0],
	                                                "z":[0,0,1,0,1,1]} },
		{ attribute: 'edge_midpoints',      value: {"x":[0.5, 0.0, 0.0, 0.5, 0.5, 0.0 ],
												    "y":[0.0, 0.5, 0.0, 0.5, 0.0, 0.5 ],
	                                                "z":[0.0, 0.0, 0.5, 0.0, 0.5, 0.5 ]} },
