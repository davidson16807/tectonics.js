...
function ColorscaleRasterView(options) {
    ...
    const min_color = hex_color_to_three_js_vector(invariant_options['min_color'] || 0.);
    const max_color = hex_color_to_three_js_vector(invariant_options['max_color'] || 0.);
    ...
    const fragmentShader = fragmentShaders.colorscale;
