...
namespace rasters {
	...
	public:
			...
			//	arrow_areas(0),
		{
			...
			edge_endpoint_a             = get(vertex_positions, edge_vertex_id_a );
			edge_endpoint_b             = get(vertex_positions, edge_vertex_id_b );
			...
			//arrow_face_id_from        = uints(arrow_count);
			//arrow_face_id_to          = uints(arrow_count);
			arrow_endpoint_from         = get(vertex_positions, arrow_vertex_id_from);
			arrow_endpoint_to           = get(vertex_positions, arrow_vertex_id_to  );
			...
			arrow_normals	 			= (get(vertex_normals, arrow_vertex_id_from) + get(vertex_normals, arrow_vertex_id_to)) / 2.f; 
