...
namespace composites
{
	...
	void sign(const numerics<T>& a, numerics<Tout>& out)
	{
		for (unsigned int i = 0; i < a.size(); ++i)
		{
			out[i] = std::sign(a[i]);
	...
	template <class T>
	void min(const numerics<T>& a, const numerics<T>& b, numerics<T>& out)
	{
		for (unsigned int i = 0; i < a.size(); ++i)
		{
	...
	template <class T>
	void min(const numerics<T>& a, const T b, numerics<T>& out)
	{
		for (unsigned int i = 0; i < a.size(); ++i)
		{
			out[i] = a[i] < b? a[i] : b;
	...
	template <class T>
	void max(const numerics<T>& a, const numerics<T>& b, numerics<T>& out)
	{
		for (unsigned int i = 0; i < a.size(); ++i)
		{
			out[i] = a[i] > b[i]? a[i] : b[i];
	...
	template <class T>
	void max(const numerics<T>& a, const T b, numerics<T>& out)
	{
		for (unsigned int i = 0; i < a.size(); ++i)
		{
			out[i] = a[i] > b? a[i] : b;
	...
	/// representations.
	template<typename T>
	void isnan(const numerics<T>&  x, primitives<bool>& out)
	{
		for (unsigned int i = 0; i < x.size(); ++i)
		{
			out[i] = std::isnan(x[i]);
	...
	/// representations.
	template<typename T>
	void isinf(const numerics<T>&  x, primitives<bool>& out)
	{
		for (unsigned int i = 0; i < x.size(); ++i)
		{
			out[i] = std::isinf(x[i]);
	...
	template<typename T>
	void fma(const T a, const numerics<T>& b, const numerics<T>& c, numerics<T>& out)
	{
		for (unsigned int i = 0; i < c.size(); ++i)
		{
			out[i] = a * b[i] + c[i];
	...
	template<typename T>
	void fma(const numerics<T>& a, T b, const numerics<T>& c, numerics<T>& out)
	{
		for (unsigned int i = 0; i < c.size(); ++i)
		{
			out[i] = a[i] * b + c[i];
	...
	template<typename T>
	void fma(const T a, const T b, const numerics<T>& c, numerics<T>& out)
	{
		T ab = a*b;
		for (unsigned int i = 0; i < c.size(); ++i)
		{
	...
	template<typename T>
	void fma(const numerics<T>& a, const numerics<T>& b, const T c, numerics<T>& out)
	{
	...
	template<typename T>
	void fma(const T a, const numerics<T>& b, const T c, numerics<T>& out)
	{
		for (unsigned int i = 0; i < b.size(); ++i)
		{
			out[i] = a * b[i] + c;
	...
	template<typename T>
	void fma(const numerics<T>& a, const T b, const T c, numerics<T>& out)
	{
		for (unsigned int i = 0; i < a.size(); ++i)
		{
			out[i] = a[i] * b + c;
